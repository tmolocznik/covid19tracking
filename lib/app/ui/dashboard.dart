...
import 'package:covid19tracking/app/repository/data_repository.dart';
import 'package:covid19tracking/app/repository/endpoints_data.dart';
import 'package:covid19tracking/app/services/api.dart';
import 'package:covid19tracking/app/ui/show_alert_dialog.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('MOVE MEDICAL - COVID-19 Tracker'),
      ),
